...
public class Terminal extends javax.swing.JFrame {
    ...
    private static  boolean apertadoEnter = false;
    ...
    private void terminalTextKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_terminalTextKeyPressed
        if(!apertadoEnter){
            if(evt.getKeyCode() == KeyEvent.VK_ENTER){
                ...
                pai.getPilhaTipos().addLast(pai.getCheckpointTipRea());
                terminalText.setEditable(false);
                terminalText.append("\n");
                pai.requestFocus();
    ...
    public static boolean isApertadoEnter() {
        return apertadoEnter;
    }

    public static void setApertadoEnter(boolean a) {
        apertadoEnter = a;
    }
