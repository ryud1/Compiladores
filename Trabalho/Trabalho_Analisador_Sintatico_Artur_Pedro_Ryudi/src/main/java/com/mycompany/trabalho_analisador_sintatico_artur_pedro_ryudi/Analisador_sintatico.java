...
import com.mycompany.trabalho_analisador_sintatico_artur_pedro_ryudi.ParseException;
...
public class Analisador_sintatico implements Analisador_sintaticoConstants {
  ...
  final public void ComecoConst() throws ParseException {
    DecConst();
    ComecoConstL();
  }

  final public void ComecoConstL() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case VAR:
      DecVar();
      break;
  ...
  final public void ComecoVar() throws ParseException {
    DecVar();
    ComecoVarL();
  }

  final public void ComecoVarL() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case CONST:
      DecConst();
      break;
  ...
  final public void ListaComandosL() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case GET:
    case PUT:
    case IF:
