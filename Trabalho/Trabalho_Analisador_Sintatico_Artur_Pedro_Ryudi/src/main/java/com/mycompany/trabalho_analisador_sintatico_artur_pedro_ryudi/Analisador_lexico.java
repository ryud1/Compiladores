        ...
        while (true) {
            ...
            switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
                ...
                case DIVISAO_INTEIRA:
                    ...
                    texto+="simbolo: DIVISAO_INTEIRA\n";
                    break;
                case RESTO_DIVISAO_INTEIRA:
                    jj_consume_token(RESTO_DIVISAO_INTEIRA);
                    texto+="simbolo: RESTO_DIVISAO_INTEIRA\n";
                    break;
                case IGUAL:
                ...
                case EXCLAMACAO:
                    ...
                    break;
                case CONSTANTES_NUMERICAS:
                    n = jj_consume_token(CONSTANTES_NUMERICAS);
                    texto+="Numero: "+n.image+"\n";
                    break;
                case IDENTIFICADOR:
                    ...
                    break;
                case A_F_ASPAS:
                    jj_consume_token(A_F_ASPAS);
                    texto+="simbolo: A_F_ASPAS\n";
                    break;
                case A_F_APOSTROFO:
                    jj_consume_token(A_F_APOSTROFO);
                    texto+="simbolo: A_F_APOSTROFO\n";
                    break;
                case ERRO_SINTATICO:
                    n = jj_consume_token(ERRO_SINTATICO);
                    int linha = jj_input_stream.retornalegal();
                    int coluna = jj_input_stream.retornalegal2();
                    this.LinhasErro.add(linha+"");
                    this.ColunasErro.add(coluna+"");
                    this.TokensErro.add(n.image+"");
                    break;
                default:
                    jj_la1[1] = jj_gen;
                    jj_consume_token(-1);
