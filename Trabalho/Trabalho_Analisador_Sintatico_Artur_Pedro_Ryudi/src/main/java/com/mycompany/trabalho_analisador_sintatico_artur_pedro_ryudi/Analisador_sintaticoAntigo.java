...
public class Analisador_sintaticoAntigo implements Analisador_sintaticoConstantsAntigo {
    public static void main(String[] Args)
    {
        Analisador_sintaticoAntigo analisador2 = new Analisador_sintaticoAntigo(System.in);
  ...
  public   Analisador_sintaticoTokenManagerAntigo token_source;
  ...
  public Analisador_sintaticoAntigo(java.io.InputStream stream) {
      this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public Analisador_sintaticoAntigo(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new SimpleCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new Analisador_sintaticoTokenManagerAntigo(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public Analisador_sintaticoAntigo(java.io.Reader stream) {
  ...
  public Analisador_sintaticoAntigo(Analisador_sintaticoTokenManagerAntigo tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(Analisador_sintaticoTokenManagerAntigo tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
