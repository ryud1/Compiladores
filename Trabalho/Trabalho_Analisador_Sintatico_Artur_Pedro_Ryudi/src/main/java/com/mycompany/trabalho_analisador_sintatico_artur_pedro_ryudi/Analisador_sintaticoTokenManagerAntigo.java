...
/** Token Manager. */
public class Analisador_sintaticoTokenManagerAntigo implements Analisador_sintaticoConstantsAntigo
{
...
/** Constructor. */
public Analisador_sintaticoTokenManagerAntigo(SimpleCharStream stream){
...
/** Constructor. */
public Analisador_sintaticoTokenManagerAntigo(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
